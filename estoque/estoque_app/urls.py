...
urlpatterns = [
    ...
    path('adicionar_bem', views.adicionar_bem, name="adicionar_bem"),
    ...
    path('bem/listar_bem', views.listar_bems, name='listar_bems'),
    path('bem/adicionar/', views.adicionar_bem, name='adicionar_bem'),
    path('bem/editar/<int:id_bem>/', views.editar_bem, name='editar_bem'),
    path('bem/deletar/<int:id_bem>/', views.deletar_bem, name='deletar_bem'),
    
    # URLs para Movimentação de Estoque
    path('movimentacao/', views.listar_movimentacoes, name='listar_movimentacoes'),
     path('movimentacao/listar_movimentacoes', views.listar_movimentacoes, name='listar_movimentacoes'),
